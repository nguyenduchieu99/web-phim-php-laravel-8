...
<body class="home blog halimthemes halimmovies" data-masonry="">
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    ...
                                    @foreach ($country as $key => $cou)
                                        <li><a title="{{ $cou->title }}"
                                                href="{{ route('country', $cou->slug) }}">{{ $cou->title }}</a>
                                        </li>
                                    @endforeach
    ...
    <script async defer crossorigin="anonymous"
        src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0&appId=1196000594198211&autoLogAppEvents=1"
        nonce="RbX5DY61"></script>
    ...
    {{-- Ấn vào trailler chạy xuống xem trailler --}}
    <script type="text/javascript">
