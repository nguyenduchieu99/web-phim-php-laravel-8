            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            {!! Form::label('resolution', 'Định đạng', []) !!}
                            {!! Form::select(
                                'resolution',
                                ['0' => 'HD', '1' => 'SD', '2' => 'HD Cam', '3' => 'Cam', '4' => 'FullHD', '5' => 'Trailer'],
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('category_id', $category_movie, isset($movie) ? $movie->category_id : '', [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('country_id', $country_movie, isset($movie) ? $movie->country_id : '', [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{-- {!! Form::select('genre_id', $genre_movie, isset($movie) ? $movie->genre_id : '', [
                                'class' => 'form-control',
                            ]) !!} --}}
                        ...
                        @else
                            {!! Form::submit('Cập nhập dữ liệu', ['class' => 'btn btn-success']) !!}
                        @endif
                        {!! Form::close() !!}
                    </div>
                </div>
